...
<body>
    ...
    <?php
        ...
        if(isset($_POST["calcular"]) && !$error_formulario ){
            ...
            $segundosFecha1= floor(mktime(1,0,0,substr($_POST["fecha1"],3,2),substr($_POST["fecha1"],0,2),substr($_POST["fecha1"],6,4)) / 86400);
            $segundosFecha2= floor(mktime(1,0,0,substr($_POST["fecha2"],3,2),substr($_POST["fecha2"],0,2),substr($_POST["fecha2"],6,4)) / 86400);
            $resultado = 0;
