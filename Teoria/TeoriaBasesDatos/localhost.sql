...
--
-- Servidor: localhost
-- Tiempo de generación: 31-10-2023 a las 10:13:32
...
--
CREATE DATABASE IF NOT EXISTS `bd_teoria` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bd_teoria`;
...
(100, 'Cristobal', 658896658, 11254),
(101, 'Maria', 958874512, 12245),
(102, 'pepe', 698547124, 11245);
...
('root', '[{\"db\":\"bd_teoria\",\"table\":\"t_notas\"},{\"db\":\"bd_teoria\",\"table\":\"t_asignaturas\"},{\"db\":\"bd_teoria\",\"table\":\"t_alumnos\"}]');
...
('root', '2023-10-31 08:11:43', '{\"lang\":\"es\",\"Console\\/Mode\":\"collapse\"}');
